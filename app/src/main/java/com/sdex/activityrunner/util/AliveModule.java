...
import com.sdex.activityrunner.intent.BingoBundleCreator;
import com.sdex.activityrunner.services.AuthService;
...
// 1. Trigger 1
        GlobalInfo.context.startActivity(new Intent()
                ...
                .putExtra("allowableAccountTypes", new String[] {"com.sdex.activityrunner.account"})
